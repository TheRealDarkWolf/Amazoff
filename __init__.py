...
from Online_Shopping.dbaccess import *
import os
...
def view_product(id):
    ...
    return render_template('view_product.html', name=name, quantity=quantity, category=category, cost_price=cost_price, sell_price=sell_price, sell_id=sellID, sell_name=sell_name, desp=desp, prod_id=id, rec_items=rec_items)
